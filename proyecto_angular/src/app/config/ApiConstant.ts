...
type ApiConstantProps = {
  readonly ARTICLE: {
    ...
    readonly GET_LAST_ARTICLES: string,
...
const ApiConstant: ApiConstantProps = {
  ARTICLE: {
    ...
    GET_LAST_ARTICLES: `http://${Config.APP_API_HOST}:${Config.APP_PORT}${Config.APP_API_PREFIX}/article/all/${Config.DEFAULT_NR_OF_ARTICLES_HOMEPAGE}`,
